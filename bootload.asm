;bootload.asm
;Michael Black, 2007
;Modified by Whirligig231, 2016
;
;This is a simple bootloader that loads and executes a kernel at sector 2

	bits 16
KSEG	equ	0x1000		;kernel goes into memory at 0x10000
KSIZE	equ	14		;kernel is at most 14 sectors (and probably less)
KSTART	equ	2		;kernel lives at sector 2
